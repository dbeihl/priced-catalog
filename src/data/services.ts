...
const catalogServices: Service[] = [
  ...
  {
    id: "painting",
    name: "Interior bedroom repaint",
    category: "general",
    blurb: "One average bedroom, two coats, and the prep for a clean finish.",
    description:
      "One average bedroom, about 132 square feet of floor with 8-foot walls, in one wall color and two coats. Normal-condition walls get protection, minor nail-hole prep, painting, and cleanup.",
    pricing: {
      model: "flat",
      price: 510,
      unit: "room",
      assumptions: [
        "One average bedroom, about 132 sq ft with 8-foot walls",
        "One wall color and two coats",
        "Normal-condition walls",
      ],
    },
    basis: {
      hours: 6,
      note: "One hour to protect and prep, four to cut and roll two coats, and one to reset and clean up.",
    },
    marketBand: {
      low: 300,
      high: 800,
      ...
      note: "This national professional-project range includes materials; the source does not separate them from labor.",
    },
    materials: "client-supplied",
    includes: [
      "Protection",
      "Minor nail-hole prep",
      "Two coats on the walls",
      "Cleanup",
    ],
    excludes: ["Ceiling", "Trim", "Doors", "Major repairs", "Paint"],
    confirmBy: "walkthrough",
    status: "offered",
  },
  {
    id: "small-repairs",
    name: "Two-hour repair visit",
    category: "general",
    blurb: "Two hours for straightforward repairs with materials on site.",
    description:
      "Up to two hours for one straightforward non-structural repair or a short list, such as drywall-hole repair, touch-up painting, blind or door-hardware installation, or a sticking-door adjustment.",
    pricing: {
      model: "flat",
      price: 170,
      unit: "visit",
      assumptions: [
        ...
        "One straightforward non-structural repair or a short list",
      ],
    },
    basis: {
      hours: 2,
      note: "Two hours on site. Shopping and travel are outside this visit.",
    },
    marketBand: {
      low: 150,
      high: 450,
      ...
      note: "Indianapolis small-repair project range.",
    },
    materials: "client-supplied",
